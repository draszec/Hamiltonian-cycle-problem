...
public class HamiltonianCycleGreedy {
    private int[][] graph;
    private List<Integer> path = new ArrayList<>();
    private boolean[] visited;
    private int vertices;
    private Random random = new Random();
    private FileWriter writer; // Dodanie obiektu FileWriter

    /**Generuje graf i inicjalizacja FileWriter **/
    public HamiltonianCycleGreedy(int vertices, double edgeProbability, FileWriter writer) {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("wyniki_algorytmu.txt", false)) { // Otwarcie pliku do dopisywania
            for (int i = 0; i < executions; i++) {
                ...
                HamiltonianCycleGreedy cycleFinder = new HamiltonianCycleGreedy(vertices, edgeProbability, writer);
